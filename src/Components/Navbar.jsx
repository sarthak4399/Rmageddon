...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <ul className="list-none md:flex hidden justify-end items-center flex-1 ">
        <li className={`font-poppins font-normal cursor-pointer text-[16px] text-dimWhite hover:text-white mr-8`}>
          <a href="/">Home</a>
        </li>
        ...
        <li className={`font-poppins font-normal cursor-pointer text-[16px] text-dimWhite hover:text-white mr-4 `}>
          <a href="/battels">Battles</a>
        </li>
        <li className={`font-poppins font-normal cursor-pointer text-[16px] text-dimWhite hover:text-white mr-2`}>
